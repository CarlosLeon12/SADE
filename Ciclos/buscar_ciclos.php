...
while ($registro = mysqli_fetch_assoc($resultado)) {
    $tabla .= "
        <tr>
            ...
            <td>
                <button class='btn-opcion text-primary'  title='Editar' onclick='window.location.href=\"ver.php?id={$registro['codigo_asignacion_grado']}\"'><i class='fas fa-edit'></i></button> 
                <button class='btn-opcion text-danger'  title='Baja' onclick='window.location.href=\"cambiar_estado.php?id={$registro['codigo_asignacion_grado']}\"'><i class='fas fa-times'></i></button>
            </td>
        </tr>
    ";
}
