    ...
    $tabla .= "
        <tr>
            ...
            <td>
                ...
                <button class='btn-opcion text-primary'  title='Baja' onclick='window.location.href=\"Habilitar_Maestro.php?id={$registro['codigo_profesor']}\"'><i class='fas fa-check'></i></button>
            </td>
        </tr>
    ";
}
